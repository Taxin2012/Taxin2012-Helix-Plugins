		...
		function SWEP:draw3D2DHUD()
			...
			cam.Start3D2D(att.Pos + ang:Forward() * 4, ang, self.HUD_3D2DScale)
				cam.IgnoreZ(true)
					...
					draw.ShadowText(bool and L( self.Primary.Ammo ) or self.Primary.Ammo, "CW_HUD48", 90, 100, self.HUDColors.white, self.HUDColors.black, 2, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER) --L("cwAmmo_" .. self.Primary.Ammo) or 
